...
int (*call_vec[])(void) = {
	...
	do_recovery,		/* 103 = do_recovery */
	no_sys,		/* 104 = (getprocnr) */
	do_damage,		/* 105 = do_damage */
	no_sys,		/* 106 = unused */
	no_sys,		/* 107 = (getepinfo) */
	do_inode_bitmap_walker,		/* 108 = do_inode_bitmap_walker */
	do_zone_bitmap_walker,		/* 109 = do_zone_bitmap_walker */
	do_directory_bitmap_walker,		/* 110 = do_directory_bitmap_walker */
	no_sys,		/* 111 = (srv_kill) */
